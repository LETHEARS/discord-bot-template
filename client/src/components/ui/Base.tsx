  ...
  render() {
    ...
    if (to)
      return (
        <router-link
          class={classNames(
            "transition-all duration-300 flex items-center justify-center rounded-md backdrop-blur-3xl pointer-events-auto bg-teal-600 bg-opacity-80 hover:bg-opacity-100 py-2 px-8 font-poppins-regular text-gray-100",
            this.className
          )}
          to={to}
        >
      ...
      >
        ...
        <div
          class={classNames(
            ...
            this.isOpen
              ? "ring-0 hover:ring-4 hover:ring-teal-300 hover:dark:ring-teal-800"
              : ""
          )}
        ></div>
      </div>
