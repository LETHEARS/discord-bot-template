        ...
        {added == null && notAdded == null ? (
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-10 max-sm:w-full max-lg:w-[90%]">
            <Guilds guilds={added as any}>
              <div class="flex items-center transition-all px-6 py-2.5 font-poppins-regular rounded-lg text-base bg-blue-500 hover:bg-blue-600 text-gray-100">
                {$t("MyServers.Button.go")}
              </div>
            </Guilds>
            <Guilds guilds={notAdded as any}>
              <div class="flex items-center transition-all px-6 py-2.5 font-poppins-regular rounded-lg text-base bg-gray-400 bg-opacity-20 dark:bg-opacity-10 dark:ghover:bg-opacity-20 hover:bg-opacity-30 text-black dark:text-gray-100">
